  ...
  itinerary: [
    {
      ...
      items: [
        ...
        { time: "4:30 pm",  text: "3-hour yacht cruise, food & drinks included. Wear swimwear + bring a change of clothes 🛥️" },
        { time: "After",    text: "Go with the flow: music, games, partying 🍸" },
      ],
    },
    {
      day: "Sat · Oct 10", title: "The big day & night two",
      items: [
        { time: "Morning",  text: "Free for all: sleep in or explore the hotel", tag: "optional" },
        { time: "Midday",   text: "Lunch in historic Cabo San Lucas" },
        { time: "2-5 pm",   text: "Walk around Cabo San Lucas" },
        { time: "5-7 pm",   text: "Rest & recharge at the hotel" },
        { time: "7:30 pm",  text: "Dinner at Ilios (Greek) 🍽️" },
